...
export default function GlobalReach() {
  ...
  // 👉 yahan se overlap add kar rahe hain
  const OVERLAP_X = -30; // jitna overlap chahiye (px) – 20–50 perfect range
  ...
  tl.to(
    cards,
    {
      ...
      left: (i) =>
        positions[i].left +
        deltaX -
        (total - 1 - i) * OVERLAP_X, // ← yahan se gaps compress ho rahe
      rotation: (i) => endRotations[i],
      ease: "none",
    },
    0
  );
